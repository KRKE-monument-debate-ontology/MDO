...
<table style="width: 100%; border-collapse: collapse; border: none;">
  <tr style="border: none;">
    ...
    <td style="border: none; padding: 5px 10px; vertical-align: middle;">
      <strong style="color: #4a4a4a; font-size: 0.95em;">Alice Piazzi</strong><br/>
      <a href="mailto:alice.piazzi@studio.unibo.it" style="color: #b76e79; font-size: 0.85em; text-decoration: none;">alice.piazzi@studio.unibo.it</a>
    </td>
  </tr>
  <tr style="border: none;">
    <td style="width: 40px; border: none; padding: 5px 0;">
    ...
    <td style="border: none; padding: 5px 10px; vertical-align: middle;">
      <strong style="color: #4a4a4a; font-size: 0.95em;">Anna Pasetto</strong><br/>
      <a href="mailto:anna.pasetto2@studio.unibo.it" style="color: #b76e79; font-size: 0.85em; text-decoration: none;">anna.pasetto2@studio.unibo.it</a>
    </td>
  </tr>
  <tr style="border: none;">
    <td style="width: 40px; border: none; padding: 5px 0;">
    ...
    <td style="border: none; padding: 5px 10px; vertical-align: middle;">
      <strong style="color: #4a4a4a; font-size: 0.95em;">Francesca Gaeta</strong><br/>
      <a href="mailto:francesca.gaeta3@studio.unibo.it" style="color: #b76e79; font-size: 0.85em; text-decoration: none;">francesca.gaeta3@studio.unibo.it</a>
    </td>
  </tr>
  <tr style="border: none;">
    <td style="width: 40px; border: none; padding: 5px 0;">
    ...
    <td style="border: none; padding: 5px 10px; vertical-align: middle;">
      <strong style="color: #4a4a4a; font-size: 0.95em;">Matilde Passafaro</strong><br/>
      <a href="mailto:matilde.passafaro@studio.unibo.it" style="color: #b76e79; font-size: 0.85em; text-decoration: none;">matilde.passafaro@studio.unibo.it</a>
    </td>
  </tr>
</table>
