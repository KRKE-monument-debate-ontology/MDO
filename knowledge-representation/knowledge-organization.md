...
To represent the changing in values and the involvement of actors over time, we adopted the  <mark style="background-color:purple;">**Time Indexed Participation**</mark> pattern, which models participation not as a static relation but as a contextualized situation in which a **Stakeholder** takes part in an **Activity** during a specific time interval and with a given role.\
...
On top of this participatory structure, we integrated the model of <mark style="color:$info;background-color:$info;">**Cognitive Perspectivisation**</mark> proposed by Gangemi and Presutti in _Formal Representation and Extraction of Perspectives_. From this framework, we adapted the core classes **BackgroundKnowledge**, **Eventuality**, **Cut**, **Lens**, and **Attitude**, aligning them with the needs of our domain.
