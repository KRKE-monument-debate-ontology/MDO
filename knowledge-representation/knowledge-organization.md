...
On top of this participatory structure, we integrated the model of <mark style="color:orange;background-color:orange;">Cognitive Perspectivisation</mark> proposed by Gangemi and Presutti in _**Formal Representation and Extraction of Perspectives**_. From this framework, we adapted the core classes aligning them with the needs of our domain:
