...
{% stepper %}
{% step %}
<mark style="color:$primary;">**Preliminary Research**</mark>

we began by reviewing existing literature on controversial monuments, cultural heritage debates, and cancel culture.
{% endstep %}
...
{% step %}
<mark style="color:$primary;">**Ontology Construction**</mark>

based on the glossary and scenarios, we designed the ontology by defining classes, properties, domains, and ranges. Where possible, we reused existing ontologies and vocabularies (e.g., schema:Event, skos:Concept) to enhance interoperability.
{% endstep %}
