...
4. **Scenario Development**: for each selected statue, we developed user scenarios using LLM, to describe the debate from opposing perspectives: those advocating for removal and those supporting preservation.
